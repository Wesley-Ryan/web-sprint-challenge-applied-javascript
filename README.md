...
1. What is the DOM?
   The Document Object Model is a programming interface we can use to create the ability to interact with the user and generate or update the html.

2. What is an event?
   An event is something that happened such as a click or a keydown. It is the user interacting with the browser.

3. What is an event listener?
   A listener is a piece of code we write and attach to a Node to react to the input from the user via events.

4. Why would we convert a NodeList into an Array?
   So we can map over it and have the ability to manipulate it.

5. What is a component?
   A component is an independent resuable piece of code.
